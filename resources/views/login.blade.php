            ...
            <div class="card-body">
                ...
                <form id="login-form" autocomplete="off">
                    ...
                    <div class="card-actions mt-3 max-w-full border">
                        <button
                            class="text-md w-full rounded-md bg-blue-500 p-2 text-white shadow-sm focus:outline-none"
                            id="submit-login"
                            data-url-login="{{ url("/authenticating") }}"
                            type="submit"
                        >
                ...
                <div class="card-actions max-w-full border">
                    <button
                        class="text-md btn w-full border-0 bg-slate-600 text-white hover:bg-slate-600"
                    >
                        Register
                    </button>
                </div>
