...
@section('content')
	<div class="app" data-page="dashboard">
		<button class="fixed left-3 top-3 z-10 rounded bg-red-500 p-2 text-white" id="logout"
			data-logout-url="{{ url('dashboard/logout') }}">
			Logout
		</button>
		...
		<div class="w-[30rem]">
			...
			<div class="my-7">
				<table class="min-w-full divide-gray-300 text-[#353935]" id="table-barang"
					...
					<thead class="bg-slate-100">
						<tr>
							<th class="py-3 ps-3 text-left font-medium capitalize tracking-wider">
								No
							</th>
							<th class="py-3 ps-3 text-left font-medium capitalize tracking-wider">
								Nama Barang
			...
			<div class="my-5 max-w-full">
				...
				<div class="h-[27rem] overflow-auto py-5">
					...
					{{-- konten data kampus --}}
					<div class="hidden" id="list-kampus-container">
						<div class="grid grid-cols-2 gap-4" id="list-kampus" data-get-kampus-url="{{ url('dashboard/data-kampus') }}">
						</div>
					</div>
				</div>
				{{-- paginasi --}}
				<div class="mt-5 flex items-center justify-between gap-4">
					...
					<div class="flex gap-3" id="pagination-button"></div>
				</div>
			</div>
		</div>
		{{-- chat box --}}
		<div class="dropdown-end dropdown-top dropdown fixed bottom-0 right-0 z-10 m-3">
			<label class="btn mx-1 my-3 bg-white hover:bg-white" id="button-chat-room" tabindex="0">
			...
			<div class="menu dropdown-content z-[1] w-[22rem] bg-white shadow-md" id="chat-room" tabindex="0">
				<div class="card h-[55vh] rounded-md">
					<div class="card-body px-6 py-0">
						<h2 class="card-title mt-3" id="title-chat">
							Live Chat!
						</h2>
						<hr />
						...
						<div class="card-actions absolute bottom-4 mt-3 hidden" id="chat-form">
							<form id="form-chat" autocomplete="off">
								...
								<div class="join">
									...
									<button class="btn join-item border border-gray-300 hover:border-gray-300" id="send-msg" type="submit">
										Kirim
									</button>
								</div>
							</form>
