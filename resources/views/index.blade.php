	...
	<body>
		<div class="max-w-full px-5 md:px-0" id="app" data-page="dashboard">
			...
			<div class="mx-auto w-full md:w-2/5">
				...
				<div class="my-7">
					<table class="min-w-full text-xs sm:text-sm divide-y text-[#353935] divide-gray-300" id="table-barang" data-get-barang-url="{{ url('item') }}">
						<thead>
							<tr>
								<th class="py-3 text-left ps-3 font-medium uppercase tracking-wider">No</th>
								<th class="py-3 text-left ps-3 font-medium uppercase tracking-wider">Nama Barang</th>
								<th class="py-3 text-left ps-3 font-medium uppercase tracking-wider">Harga Barang</th>
							</tr>
						</thead>
